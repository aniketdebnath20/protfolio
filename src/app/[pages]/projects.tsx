    ...
    <section id="projects" className="py-20 px-6 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <div
          ...
          className={`text-center mb-16 transition-all duration-800 ${titleAnimation.isVisible
        ...
        >
          {projects.map((project, index) => (
            <Card
              key={index}
              className={`group overflow-hidden hover:shadow-glow transition-all duration-700 border-border/50 ${projectsAnimation.isVisible
